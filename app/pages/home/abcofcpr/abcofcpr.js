...
var abcofcprModel = (function (_super) {
    ...
    abcofcprModel.prototype.setcontent = function(){
      ...
      self.set("abcofcprcontentb2","\n•Adrenaline Nebulization   - 0.4 ml/kg upto a maximum of 5 ml of a 1:1000 dilution, Can be repeated every 20-30 minutes for a \n•maximum of 3 nebulisations\n•Note if child is hypoxic – Give nebulization with oxygen\n");
      ...
      self.set("abcofcprcontentabc2","normal breathing has pulse >60 \nPlace the child in recovery position  - monitor the child \n");
      self.set("abcofcprcontentabc3","no normal breathing has pulse \n 1 breath every 3-5 sec if pulse is >60<br/>Add compressions if pulse < 60 \n");
